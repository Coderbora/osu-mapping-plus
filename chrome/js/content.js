...
const reloadSubscriptions = async () => {
    subscriptions = await new Promise(resolve => chrome.runtime.sendMessage({q: "subscriptions"}, response => resolve(response)))
}
const reloadNotifications = async () => {
    notifications = await new Promise(resolve => chrome.runtime.sendMessage({q: "notifications"}, response => resolve(response)))
}
...
<button class="nav-button nav-button--stadium js-click-menu" id="subscriptionsbutton">
    ...
    $("#deleteAllNotifications").click(function () {
        chrome.runtime.sendMessage({q: "manageNotification", action: "deleteAll"})
    });
    generateContainer();
}
