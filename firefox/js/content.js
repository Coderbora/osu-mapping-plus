...
const reloadSubscriptions = async () => { subscriptions = await browser.runtime.sendMessage({q: "subscriptions"}); }
const reloadNotifications = async () => { notifications = await browser.runtime.sendMessage({q: "notifications"}); }
